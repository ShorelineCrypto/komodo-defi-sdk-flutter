...
GithubCoinConfigProvider createTestProvider({
  ...
  return GithubCoinConfigProvider(
    ...
    coinsGithubContentUrl:
        coinsGithubContentUrl ??
        'https://raw.githubusercontent.com/ShorelineCrypto/coins',
    coinsGithubApiUrl:
        coinsGithubApiUrl ??
        'https://api.github.com/repos/ShorelineCrypto/coins',
...
void main() {
  group('GithubCoinConfigProvider CDN mirrors', () {
    ...
    test('falls back to raw content when branch has no mirror', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/ShorelineCrypto/coins/dev/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('branchOrCommit override falls back to raw when not mirrored', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/ShorelineCrypto/coins/feature/example/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('uses raw URL for commit hash even when CDN is available', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/ShorelineCrypto/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('handles null mirrors and falls back to raw', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/ShorelineCrypto/coins/master/utils/coins_config_unfiltered.json',
      );
    });
    ...
    group('non-master/main branch behavior', () {
      ...
      test('feature branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/feature/new-coin-support/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('release branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/release/v1.2.0/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('hotfix branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/hotfix/urgent-fix/utils/coins_config_unfiltered.json',
        );
      });
    });
    ...
    group('commit hash behavior', () {
      ...
      test('different commit hash uses GitHub raw URL', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/abc123def456789012345678901234567890abcd/utils/coins_config_unfiltered.json',
        );
      });
    ...
    group('edge cases and validation', () {
      ...
      test('39-character string is treated as branch name', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/f7d8e39cd11c3b6431df314fcaae5becc281413/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('41-character string is treated as branch name', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136a/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('40-character string with non-hex characters is treated as branch', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/ShorelineCrypto/coins/f7d8e39cd11c3b6431df314fcaae5becc281413g/utils/coins_config_unfiltered.json',
        );
      });
    });
  });
  ...
  group('GithubCoinConfigProvider', () {
    ...
    test('buildContentUri normalizes coinsPath entries', () {
      ...
      expect(
        rawUri.toString(),
        'https://raw.githubusercontent.com/ShorelineCrypto/coins/master/coins/KMD.json',
      );
    });
